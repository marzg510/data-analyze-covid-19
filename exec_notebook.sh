...
jupyter nbconvert --to notebook --inplace --execute covid-19-jp-gov-pref.ipynb --ExecutePreprocessor.timeout=1800 --allow-errors $DEBUG |& log
...
jupyter nbconvert --to notebook --inplace --execute covid-19-owid-global-vaccine.ipynb --ExecutePreprocessor.timeout=1800 --allow-errors $DEBUG |& log
